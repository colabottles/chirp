<template>
  <div
    ...
    <button v-if="isOwn" role="menuitem" class="context-menu-item danger" @click="handleDelete">
    ...
    <!-- Mute, block, report — other users' posts only -->
    <template v-if="!isOwn && session?.user">
